...
public class PAdESNestedSignatureFieldTest extends AbstractPAdESTestSignature {
    ...
    public void init() throws Exception {
        documentToSign = new InMemoryDocument(getClass().getResourceAsStream("/nested-signature-field.pdf"));
        ...
        signatureParameters.getImageParameters().setImage(RED_CROSS_IMAGE);
